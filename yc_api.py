...
class ThunderRemoteDownload(object):
    ...
    def login(self):
        ...
        login_page = self.urlopen('https://login.xunlei.com/sec2login/', headers={'User-Agent': USER_AGENT},
                                  data={'u': username, 'p': password, 'verifycode': verification_code, 'login_enable': '0',
